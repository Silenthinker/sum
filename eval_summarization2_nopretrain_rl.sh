...
export MODEL_DIR="$(pwd)/sum_conv_seq2seq_nopretrain_rl"
...
python seq2seq/metrics/pythonrouge/rouge_scorer.py -ref_dir $DATA_PATH/reference/ -sum_dir $DATA_PATH/summary/
